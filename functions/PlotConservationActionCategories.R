PlotConservationActionCategories <- function(EditedData){ 
  ...
  # 
  # 
  # ## what is the distribution of conservation action categories across the studies? - Wenxin
  # table(EditedData$`Conservation Action Category`)
  # 
  # barplot(table(EditedData$`Conservation Action Category`))
  # 
  par(mar=c(2,15,2,2))
  plt_cac <- barplot(table(EditedData$`Conservation Action Category`),horiz = TRUE, las=1) 
  # 
